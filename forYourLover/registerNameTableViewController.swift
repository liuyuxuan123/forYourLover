//
//  registerNameTableViewController.swift
//  forYourLover
//
...
class registerNameTableViewController: UITableViewController,UITextFieldDelegate {
...
*/
    ...
    func checkValidName() {
        ...
        let nameText = registerNameTextField.text ?? ""
