//
//  registerCodeTableViewController.swift
//  forYourLover
//
...
class registerCodeTableViewController: UITableViewController,UITextFieldDelegate{
...
*/
    ...
    */
    ...
    func checkValidName() {
        ...
        let nameText = registerCodeTextField.text ?? ""
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if sender === saveButton {
            destinationViewController.userImformation = userAccount(userName: (destinationViewController.userImformation?.userName)!, userEmail: (destinationViewController.userImformation?.userEmail)!, userCode: registerCodeTextField.text!, userAge: (destinationViewController.userImformation?.userAge)!, userGender: (destinationViewController.userImformation?.userGender)!, userInterestField: destinationViewController.userImformation?.userInterestField)
            print("changeCode")
